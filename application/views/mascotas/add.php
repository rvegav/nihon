		...
		<form id="frm_mascota" data-parsley-validate="" class="" action="" method="POST">
			<div class="row">
				<div class="col-md-4 offset-3">
					...
					<div class="input-group">
						<input type="text" class="form-control" id="mas_id" name="mas_id" readonly value="<?php echo $maximo->MAXIMO;?>">
					</div>	
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 offset-3">
					...
					<div class="input-group">
						<input type="text" id="nombreMascota" placeholder="Descripcion" font style="text-transform: uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase ();"   name="nombreMascota" class="form-control">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 offset-3">
					...
					<div id="custom-search-input">
						<div class="input-group">
							...
							<input type="text" name="cliente_nombre" id="cliente_nombre" class="form-control" placeholder="Buscar Dueño" disabled="disabled" required="required"/>
			...
			<div class="row">
				<div class="col-md-4 offset-3">
					...
					<div id="custom-search-input">
						<div class="input-group">
							<input type="hidden" name="raz_id" id="raz_id">	
							<input type="text" name="raza" id="raza" class="form-control" placeholder="Buscar Raza" disabled="disabled" required="required"/>
							<span class="input-group-btn">
