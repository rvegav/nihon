		...
		<form id="frm_persona" data-parsley-validate="" class="" action="" method="POST">
			<div class="row">
				<div class="col-md-3 offset-5">
					<label for="NumCiudad">Código Persona<span class="required">*</span></label>
					<div class="input-group">
						<input type="text" class="form-control" id="cod_persona" name="cod_persona" readonly value="<?php echo $maximo->MAXIMO;?>">
					</div>	
				</div>
			</div>
			<div class="row">
				<div class="col-md-3">
					...
					<div class="input-group">
						<input type="text" id="nombre" placeholder="Nombre" font style="text-transform: uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase ();"   name="nombre" class="form-control">
					</div>
				</div>
				<div class="col-md-3">
					<label class="" for="desCiudad">Apellido <span class="required">*</span></label>
					<div class="input-group">
						<input type="text" id="apellido" placeholder="Apellido" font style="text-transform: uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase ();"   name="apellido" class="form-control">
					</div>
				</div>
				<div class="col-md-3">
				...
				<div class="col-md-3">
					...
					<div class="input-group">
						<input type="text" class="form-control" id="nro_doc" name="nro_doc" placeholder="Documento">
					</div>	
				</div>
			</div>
			<div class="row">
...
<script type="text/javascript">
	...
	$("#frm_persona").submit(function(event) {
		...
		$.ajax({
			url: "<?php echo base_url()?>store_persona",
			type: 'POST',
			data: formDato
		})
