					...
					<?php if(!empty($especies)):?>
						...
						foreach($especies as $especie):?>
							<tr>
								...
								<td><?php echo $especie->esp_fecha_creacion;?></td>
								<td><?php echo $especie->esp_fecha_modificacion;?></td>
								...
								<td>
									<a href="<?php echo base_url();?>edit_especie/<?php echo $especie->esp_id;?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
									<?php if ($estado!=2): ?>
										<a href="<?php echo base_url();?>delete_especie/<?php echo $especie->esp_id;?>" class="btn btn-danger btn-delete eliminar"><i class="fa fa-trash"></i></a>
									<?php endif ?>
								</td>
							</tr>
						<?php endforeach; ?>
...
<script type="text/javascript">
	var tabla = $("#tablaEspecie").DataTable({
